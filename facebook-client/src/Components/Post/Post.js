  ...
  return (
    <Box className="Post">
      ...
      >
        ...
        <div>
          ...
          <Menu
            ...
            onClose={handleClose}
          >
            <MenuItem onClick={editPost}>Chỉnh sửa bài viết</MenuItem>
            <MenuItem
              onClick={() => {
                handleClose();
                RemovePost();
      ...
      <Box className="Actions">
        <List disablePadding>
          <ListItem
            button
            onClick={likePost}
            className={data.like.includes(UserGState.info._id) && "activeLike"}
          >
            {data.like.includes(UserGState.info._id) ? (
              <ThumbUpAltIcon />
            ) : (
          ...
          <ListItem button>
            <label htmlFor="comment">
              <ChatBubbleOutlineOutlinedIcon /> Bình luận
            </label>
          </ListItem>
        </List>
      </Box>
      ...
      <form className="addComment" onSubmit={submitComment}>
        <img src={UserGState.info.profile_pic} alt="profile" />
        <input
