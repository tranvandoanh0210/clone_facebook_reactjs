      ...
      <Box className="Profile">
        ...
        >
          ...
          >
            ...
            <label htmlFor="coverPhoto">
              <CameraAltIcon />{" "}
              <Typography className="text"> Chỉnh sửa ảnh bìa</Typography>
            </label>
          </Box>
        </Box>
            ...
            <Grid xs={12} md={6}>
              <Box className="leftSide" display="flex" alignItems="end">
                ...
                <Box className="info">
                  ...
                  <Typography variant="body1">5 bạn bè</Typography>
        ...
        <Box className="Naviagation">
          <List>
            ...
            <ListItem button>
              <Typography variant="body2">Bài đánh giá đã viết</Typography>
            </ListItem>
            <ListItem button>
              <Typography variant="body2">Quản lý các phần</Typography>
            </ListItem>
          </List>
        </Box>
        {/* Post section  */}
              ...
              <Grid xs={12} md={7}>
                ...
                {!PostGState.userPosts.length ? (
                  ...
                  >
                    ...
                    <Typography variant="h6">
                      Hãy đăng bài và bày tỏ cảm xúc của bản thân nhé
                    </Typography>
                  </Box>
                ) : (
